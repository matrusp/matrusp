...
function Persistence()
{
    ...
    if (window.sessionStorage) {
        self.read_state  = function( ) { return sessionStorage.state2; };
        self.write_state = function(d) { sessionStorage.state2 = d; return true; };
        ...
        if (userdata.addBehavior) {
            ...
            self.read_state  = function( ) { return userdata_read ("state2"   ); };
            self.write_state = function(d) { return userdata_write("state2", d); };
